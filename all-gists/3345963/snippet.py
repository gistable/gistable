...
class BOSHClient:
    ...
    def request_bosh_session(self):
        ...
        xml_stanza = "<body rid='%s' xmlns='http://jabber.org/protocol/httpbind' to='thomas-desktop' xml:lang='en' wait='60' hold='1' window='5' content='text/xml; charset=utf-8' ver='1.6' xmpp:version='1.0' xmlns:xmpp='urn:xmpp:xbosh'/>" % (self.rid)
