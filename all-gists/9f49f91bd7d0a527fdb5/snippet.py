...
class IfmapSearcher():
    ...
    def __init__(self):
        ...
        mapclient = client(("%s" % (self._args.ifmap_ip),
                            "%s" % (self._args.ifmap_port)),
                           self._args.ifmap_username,
                           self._args.ifmap_password, namespaces)
    ...
    def parse_args(self):
        ...
        parser.add_argument('--ifmap-ip', default='localhost',
            help="IP address of ifmap server")
        parser.add_argument('--ifmap-port', default='8443',
             help="Port of ifmap server")
        parser.add_argument('--ifmap-username',
            help="Username known to ifmap server")
        parser.add_argument('--ifmap-password',
        ...
        parser.add_argument('--result-metas',
            help = "Comma separated metadata names to pick in response e.g."
                   "contrail:project-virtual-network")
        parser.add_argument('--max-depth', default='1',
...
if __name__ == '__main__':
     ...
     # Example usage:
     # python ifmap_search.py --ifmap-ip localhost --ifmap-port 8443 
     #     --ifmap-username <u> --ifmap-password <p>
