...
bot_user_agents = set([
    ...
    '''COAST WebMain Pro/4.x.x.xx (Windows NT)''',
    '''CoBITSProbe''',
    ...
    '''FirstGov.gov Search - POC:firstgov.webmains@gsa.gov''',
    '''firstsbot''',
    ...
    '''IncyWincy data gatherer(webmain@loopimprovements.com''',
    '''IncyWincy page crawler(webmain@loopimprovements.com''',
    ...
    '''INGRID/3.0 MT (webcrawler@NOSPAMexperimental.net; http://webmain.ilse.nl/jsp/webmaster.jsp)''',
    '''Inktomi Search''',
    ...
    '''lawinfo-crawler/Nutch-0.9-dev (Crawler for lawinfo.com pages; http://www.lawinfo.com; webmain@lawinfo.com)''',
    ...
    '''Mozilla/4.0 (compatible; MSIE 6.0 compatible; Asterias Crawler v4; +http://www.singingfish.com/help/spider.html; webmain@singingfish.com); SpiderThread  Revision: 3.10''',
    ...
    '''Mozilla/4.0 (Mozilla; http://www.mozilla.org/docs/en/bot.html; main@mozilla.com)''',
    ...
    '''pipeLiner/0.3a (PipeLine Spider;http://www.pipeline-search.com/webmaster.html; webmain'at'pipeline-search.com)''',
    ...
    '''Searchspider/1.2 (SearchSpider; http://www.searchspider.com; webmain@searchspider.com)''',
    ...
    '''Website eXtractor''',
    '''WebsiteWorth v1.0''',
    '''Webspinne/1.0 webmain@webspinne.de''',
    ...
    '''WebTrends/3.0 (WinNT)''',
    '''WebVac (webmain@pita.stanford.edu)''',
    '''WebVal/1.0''',
    ...
    '''YahooSeeker/CafeKelsa-dev (compatible; Konqueror/3.2; FreeBSD ;cafekelsa-dev-webmain@yahoo-inc.com )''',
    ...
    '''ZipppBot/0.xx (ZipppBot; http://www.zippp.net; webmain@zippp.net)''',
    '''ZIPPPCVS/0.xx (ZipppBot/.xx;http://www.zippp.net; webmain@zippp.net)''',
